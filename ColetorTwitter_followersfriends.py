...
class CustomStreamListener(tweepy.StreamListener):
	...
	#Inserindo na coleção, se não for retweet
	if (tweet['text'][0:2]!='RT'):
		friends_ids, followers_ids = funcoestwitter.get_friends_followers_ids(twitter_api, screen_name=tweet['user']['screen_name'])
		tweet['user']['friends_ids']=friends_ids
		tweet['user']['followers_ids']=followers_ids
